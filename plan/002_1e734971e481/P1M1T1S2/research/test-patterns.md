...
```typescript
describe('moduleName', () => {
  const mockData = { /* shared test data */ };
...
import { importGroundswellPackage, type ImportResult } from '../../../src/utils/groundswell-importer.js';
...
describe('importGroundswellPackage', () => {
  ...
  describe('Successful import', () => {
    it('should import package successfully when package.json exists', async () => {
      ...
      // Execute
      const result: ImportResult = await importGroundswellPackage('test-package');
