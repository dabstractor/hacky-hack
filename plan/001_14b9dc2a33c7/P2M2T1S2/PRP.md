  ...
  describe('architect output validation', () => {
            ...
            milestones: [{
              ...
              tasks: [{
                ...
                subtasks: [{
                  ...
                  story_points: 1,
                  dependencies: [],
                  context_scope: 'CONTRACT DEFINITION: Create package.json'
                }]
              }]
            }]
          }]
    ...
    it('should contain at least one phase with proper nesting', async () => {
      ...
      if (USE_REAL_LLM) {
        ...
        expect(result.backlog[0].milestones[0].tasks[0].subtasks[0]).toBeDefined();
      }
    }, { timeout: 30000 });
          ...
          backlog: [{
            ...
            milestones: [{
              ...
              tasks: [{
                ...
                description: 'Test',
                subtasks: [
                  { id: 'P1.M1.T1.S1', type: 'Subtask', title: 'S1', status: 'Planned', story_points: 1, dependencies: [], context_scope: 'Test' },
                  { id: 'P1.M1.T1.S2', type: 'Subtask', title: 'S2', status: 'Planned', story_points: 2, dependencies: [], context_scope: 'Test' },
                  { id: 'P1.M1.T1.S3', type: 'Subtask', title: 'S3', status: 'Planned', story_points: 3, dependencies: [], context_scope: 'Test' }
                ]
              }]
            }]
          }]
    ...
    it('should log sample output for inspection', async () => {
      ...
      if (USE_REAL_LLM) {
        ...
        console.log('Sample Subtask:', result.backlog[0].milestones[0].tasks[0].subtasks[0]);
      }
    }, { timeout: 30000 });
  });
});
